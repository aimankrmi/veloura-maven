                            ...
                            <div class="col-8 col-md-5 col-xl-4 pe-5 ">
                                <table class="table table-borderless details-table">
                                    ...
                                    <tbody class="container-fluid">
                                        ...
                                        <tr class="row">
                                            <th class="col-12 col-sm-6 text-center text-sm-start" scope="row">Total
                                                Amount
                                            </th>
                                            <td class="col-12 col-sm-6 text-center text-sm-start">
                        ...
                        <div class="row">
                                                                        ...
                                                                        <div class="card-body" style="height: 350px">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                <label for="cc-number"
                                                                                    ...
                                                                                    Number</label>
                                                                                <input id="cc-number" min="16" max="16"
                                                                                    type="tel"
                                                                            ...
                                                                            <div class="form-group mt-3">
                                                                                ...
                                                                                <input value="Pay Now" type="submit"
                                                                                    class="btn btn-primary btn-lg form-control fs-6 fw-bold"
                            ...
                            <div class="col-6 d-flex p-5 justify-content-center align-items-center ">
                                <form action="paymentProcess" method="POST">
                                    ...
                                    <input type="hidden" name="showtimeId" value="${showtime.id}">
                                    <input type="submit" class="btn btn-primary mx-auto" value="Pay At Counter" <c:if
                                        test="${not allowCounterPayment}">disabled </c:if>>
