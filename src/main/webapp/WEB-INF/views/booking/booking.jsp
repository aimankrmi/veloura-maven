                    ...
                    <form action="${pageContext.request.contextPath}/${user.id==0 ? " login?message=Please login
                        ...
                        <div class="fluid-container pt-3">
                            <div class="row w-100 m-0">
                                <!--MOVIE PICTURE-->
                                <section
                                    class="w-100 mt-3 mx-auto px-0 movie-picture-section d-flex align-items-center justify-content-center">
                                    <a href="booking?id=${previousMovieId}&next=false"
                                        class="btn bg-transparent border-none btn-left"><i
                                            class="fa-solid fa-chevron-left fa-lg" style="color: #d9a93f;"></i></a>
                                    <div class=" movie-picture-wrapper  overflow-hidden " style="height: 750px;">
                                        <img src="${pageContext.request.contextPath}/assets/images/${movie.imagePath!=null? movie.imagePath:'default'}"
                                            class="img-fluid movie-img" alt="Movie Image">
                                    </div>
                                    <a href="booking?id=${nextMovieId}&next=true"
                                        class="btn bg-transparent btn-right"><i class="fa-solid fa-chevron-right fa-lg"
                                            style="color: #d9a93f;"></i></a>
                                </section>
                                ...
                                <section
                                    ...
                                    <div class="movie-desc d-flex flex-sm-row flex-column py-1">
                                        ...
                                        <div class="movie-duration  glow-white fs-5 text-center">${movie.hours}h
                                            ${movie.minutes}min</div>
                                        <div class="movie-lang text-capitalize glow-white fs-5 text-center">
                                            ${movie.language}</div>
                                    </div>
                                ...
                                <section class="row justify-content-center mx-auto">
                                    ...
                                    <!--Form to book-->
                                    <div
                                        class="col-12 col-sm-12 col-lg-7 d-flex flex-column justify-content-evenly align-items-center">


                                        <!-- MOVIE DATE -->
                                        <section
                                            class="showtimes-wrapper d-flex flex-column justify-content-center align-items-center mx-auto">
                                            ...
                                            <div class="showtimes-list mt-1 gap-2 d-flex flex-sm-row flex-column">
                                                ...
                                                <c:if test="${movie.status eq 'Ongoing'}">
                                                    <c:forEach items="${movie.availableDates}" var="availableDate"
                                                        varStatus="status">
                                                        <fmt:parseDate value="${availableDate}" type="both"
                                                            var="parsedDate" pattern="yyyy-MM-dd" />
                                                        <input onchange="checkDate()" type="radio"
                                                            class="btn-check date-input" name="date"
                                                            id="showtime_date_${status.index + 1}"
                                                            value="${availableDate}" data-date="${availableDate}"
                                                            autocomplete="off">
                                        ...
                                        <c:if test="${param.date!=null}">
                                            <c:if test="${empty showTimesByDate}">
                                                <div class="text-center glow-white mt-4">NO BOOKING AVAILABLE ON THIS
                                                    DATE</div>
                                            </c:if>
                                            <c:if test="${not empty showTimesByDate}">
                                                ...
                                                <!-- MOVIE SHOWTIMES -->
                                                <section
                                                    class="showtimes-wrapper d-flex flex-column justify-content-center align-items-center my-3">
                                                    <div class="showtimes-title">
                                                        <h1 class="glow-gold mt-3 fs-1 ">Available Showtimes</h1>
                                                    </div>
                                                    <div
                                                        class="showtimes-list mt-1 gap-2 d-flex flex-sm-row flex-column">
                                                        <c:forEach items="${showTimesByDate}" var="time"
                                                            varStatus="status">

                                                            <fmt:parseDate value="${time}" type="time" var="parsedTime"
                                                                pattern="HH:mm:ss" />
                                                            <input onclick="checkTime()" type="radio"
                                                                class="btn-check time-input" name="time"
                                                                id="showtime_time_${status.index+1}" value="${time}"
                                ...
                                <c:if test="${param.date!=null && param.time!=null && showtime.upcoming}">
                                    ...
                                    <section class="seat-selection-section w-100 mt-4 px-5 ">
                                        ...
                                        <div
                                            class="seat-selection-wrapper scrollbar-gold pb-2 fluid-container mx-auto overflow-auto">
                                                    ...
                                                    <c:forEach items="${row.value}" var="seat" varStatus="status">
                                                        ...
                                                        <div class="col-1">
                                                            <input type="checkbox" class="btn-check"
                                                                ...
                                                                data-price="${showtime.movie.price}" ${seat.isAvailable
                                                                ? "" : "disabled" } />
                                                            <label
                                                                class="btn seat-icon ${seat.isAvailable ? 'available' : 'reserved'}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content bg-dark">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-2 fw-bold text-center display-3 text-light"
                                                            id="confirmModalLabel">Selected Seat</h1>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input class="btn btn-primary" id="confirmButton" type="submit"
                                                            value="Checkout">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <section class="text-center my-4 selected-seat-text">
                                            <p class="fs-6">You selected: <span id="seat-selected-list-text"
                                                    class="seat-selected-list"></span></p>
                                        </section>
