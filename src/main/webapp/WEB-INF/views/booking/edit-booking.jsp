    ...
    <body>
        ...
        <div class="fluid-container">
            <div class="row justify-content-center py-3">
                <a href="${pageContext.request.contextPath}/viewBookingHistory" class="ms-3"><i
                ...
                <div class="col-5 col-lg-3 pe-5 ">
                    <table class="table table-borderless details-table">
                        ...
                        <tbody class="container-fluid">
                            <tr class="row">
                                <th class="col-12 col-sm-6 text-center text-sm-start" scope="row">Order ID
                                </th>
                            ...
                            <tr class="row">
                                <th class="col-12 col-sm-6 text-center text-sm-start" scope="row">Payment ID
                                </th>
                                <td class="col-12 col-sm-6 text-center text-sm-start">
                                    <c:out value="${booking.payment.id}" />
                                </td>
                            </tr>
                            <tr class="row">
                                <th class="col-12 col-sm-6 text-center text-sm-start" scope="row">Order
                                    Description
                                </th>
                                <td class="col-12 col-sm-6 text-center text-sm-start">
        ...
        <form action="${pageContext.request.contextPath}/processEditBooking" method="POST">
            ...
            <section class="seat-selection-section w-100 mt-4 px-5 ">
                ...
                <div class="seat-selection-wrapper pb-2 fluid-container mx-auto overflow-auto"
                     data-seat-booked="${booking.seats.size()}">
                            ...
                            <c:forEach items="${row.value}" var="seat" varStatus="status">
                                ...
                                <div class="col-1">
                                    <input type="checkbox" class="btn-check" name="seat"
                                           value="${seatNumber}" id="${seatNumber}" onchange="addSeat(this.id)"
                                           data-price="${showtime.movie.price}" <c:if
                                               test="${!seat.isAvailable && !bookedSeat}">
                                               disabled
                                           </c:if>
                                           />
                                    <label class="btn seat-icon 
                                           <c:choose>
                                               <c:when test="${seat.isAvailable || bookedSeat}">available</c:when>
                                               <c:otherwise>reserved</c:otherwise>
                                           </c:choose>"
                                           for="${seatNumber}">${seatNumber}
                                    </label>
                ...
                <section class="w-100 d-flex justify-content-center">
                    ...
                    <button type="button" class="btn btn-primary" id="submitButton" data-bs-toggle="modal"
